...
En consecuencia por esta decisión en esta implementación cada thread del lado del servidor debe ser capaz de acceder al mismo archivo “bets.csv” y se utilizan las operaciones de archivo del SO para realizar la coordinación de acceso al archivo para lectura y escritura ya que me parecía redundante agregar esta coordinación desde la aplicación.
